...
class DisclaimerVC_New: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBAction func readyAction(_ sender: Any) {
        dismiss(animated: false) {
            ...
            if var topController = keyWindow?.rootViewController {
                ...
                let vc = story.instantiateViewController(withIdentifier: "SelectDeviceVC") as! SelectDeviceVC
